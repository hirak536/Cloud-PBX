...
client_patterns = [
    ...
    path('<uuid:tenant_uuid>/sip/search/', views.ClientHomerSipSearchView.as_view(), name='client-sip-search'),
    path('<uuid:tenant_uuid>/sip/ladder/', views.ClientHomerSipLadderView.as_view(), name='client-sip-ladder'),
